...
public class FPVItem_Berries1 : FPVItem_Base
{
            ...
            case (int)CustomMessageContext1.ItemConsuming:
                {
                    ...
                    {
                        m_carrierPlayer.addFood(10); // FOOD VALUE HERE !!
                        m_carrierPlayer.addWater(5); // WATER VALUE HERE !!
                        NetworkingManager.singleton.server_sendWorldSoundToAllInRange(27, m_carrierPlayer.transform.position, m_carrierPlayer.entityUID);
